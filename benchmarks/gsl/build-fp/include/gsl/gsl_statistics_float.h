...
double gsl_stats_float_wmean_without_injection (const float w[], const size_t wstride, const float data[], const size_t stride, const size_t n);
...
double gsl_stats_float_wsd_without_injection (const float w[], const size_t wstride, const float data[], const size_t stride, const size_t n);
