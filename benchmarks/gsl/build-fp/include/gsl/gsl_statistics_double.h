...
double gsl_stats_wmean_without_injecton (const double w[], const size_t wstride, const double data[], const size_t stride, const size_t n);
...
double gsl_stats_wsd_without_injection (const double w[], const size_t wstride, const double data[], const size_t stride, const size_t n);
