...
run_baselines()
{
  ...
  g++ -o sequential-64 -DFT=double -DN=$N $test-INOUT.c -lm
  g++ -o sequential-80 -DFT=__float128 -DN=$N $test-INOUT.c -lm
  ...
  clang-3.4 -o temp_$test.bc -DN=$N -I$klee/include -emit-llvm -c $test-SYMBOLIC.c
  llvm-link-3.4 temp_$test.bc $benchPath/../../utils/injections.bc -o $test-SYMBOLIC.bc
  rm temp_$test.bc
