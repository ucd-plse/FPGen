; ModuleID = '/home/fptesting/FPTesting/src/klee-float/runtime/klee-libc/__cxa_atexit.c'
...
@.str1 = private unnamed_addr constant [74 x i8] c"/home/fptesting/FPTesting/src/klee-float/runtime/klee-libc/__cxa_atexit.c\00", align 1
...
define internal void @RunAtExit() #0 {
  ...
  %1 = load i32* @NumAtExit, align 4, !dbg !37, !tbaa !39
  %2 = icmp eq i32 %1, 0, !dbg !37
  br i1 %2, label %._crit_edge, label %.lr.ph, !dbg !37

.lr.ph:                                           ; preds = %0, %.lr.ph
  %i.01 = phi i32 [ %8, %.lr.ph ], [ 0, %0 ]
  %3 = zext i32 %i.01 to i64, !dbg !43
  %4 = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %3, i32 0, !dbg !43
  %5 = load void (i8*)** %4, align 8, !dbg !43, !tbaa !44
  %6 = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %3, i32 1, !dbg !43
  %7 = load i8** %6, align 8, !dbg !43, !tbaa !47
  tail call void %5(i8* %7) #4, !dbg !43
  %8 = add i32 %i.01, 1, !dbg !37
  tail call void @llvm.dbg.value(metadata !{i32 %8}, i64 0, metadata !9), !dbg !37
  %9 = load i32* @NumAtExit, align 4, !dbg !37, !tbaa !39
  %10 = icmp ult i32 %8, %9, !dbg !37
  br i1 %10, label %.lr.ph, label %._crit_edge, !dbg !37
...
define i32 @__cxa_atexit(void (i8*)* %fn, i8* %arg, i8* nocapture readnone %dso_handle) #0 {
  ...
  %1 = load i32* @NumAtExit, align 4, !dbg !53, !tbaa !39
  %2 = icmp eq i32 %1, 128, !dbg !53
  br i1 %2, label %3, label %4, !dbg !53

; <label>:3                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([74 x i8]* @.str1, i64 0, i64 0), i32 39, i8* getelementptr inbounds ([32 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0)) #5, !dbg !55
  unreachable, !dbg !55

; <label>:4                                       ; preds = %0
  %5 = zext i32 %1 to i64, !dbg !56
  %6 = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %5, i32 0, !dbg !56
  store void (i8*)* %fn, void (i8*)** %6, align 8, !dbg !56, !tbaa !44
  %7 = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %5, i32 1, !dbg !57
  store i8* %arg, i8** %7, align 8, !dbg !57, !tbaa !47
  %8 = add i32 %1, 1, !dbg !58
  store i32 %8, i32* @NumAtExit, align 4, !dbg !58, !tbaa !39
  ret i32 0, !dbg !59
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !23, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/klee-libc//home/fptesting/FPTesting/src/klee-float/runtime/klee-libc/__cxa_atexit.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/fptesting/FPTesting/src/klee-float/runtime/klee-libc/__cxa_atexit.c", metadata !"/home/fptesting/FPTesting/src/klee-float/build/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/klee-libc//home/fptesting/FPTesting/src/klee-float/runtime/klee-libc/__cxa_atexit.c]
...
!36 = metadata !{metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)"}
!37 = metadata !{i32 25, i32 0, metadata !38, null}
!38 = metadata !{i32 786443, metadata !1, metadata !4, i32 25, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/klee-libc//home/fptesting/FPTesting/src/klee-float/runtime/klee-libc/__cxa_atexit.c]
...
!54 = metadata !{i32 786443, metadata !1, metadata !11, i32 37, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/klee-libc//home/fptesting/FPTesting/src/klee-float/runtime/klee-libc/__cxa_atexit.c]
