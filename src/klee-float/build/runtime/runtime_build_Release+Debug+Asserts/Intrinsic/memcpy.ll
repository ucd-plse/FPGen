; ModuleID = '/home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memcpy.c'
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 {
  ...
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !29
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %next.gep.sum279 = or i64 %index, 16, !dbg !30
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !30
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !30
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !30
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !30
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !30
  %next.gep103.sum296 = or i64 %index, 16, !dbg !30
  %7 = getelementptr i8* %destaddr, i64 %next.gep103.sum296, !dbg !30
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !30
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !30
...
.lr.ph:                                           ; preds = %middle.block, %.lr.ph
  ...
  tail call void @llvm.dbg.value(metadata !{i8* %13}, i64 0, metadata !17), !dbg !30
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memcpy.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memcpy.c", metadata !"/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"memcpy", metadata !"memcpy", metadata !"", i32 12, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i8* (i8*, i8*, i64)* @memcpy, null, null, metadata !13, i32 12} ; [ DW_TAG_subprogram ] [line 12] [def] [memcpy]
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memcpy.c]
